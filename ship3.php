...
<body>
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 nopad">
		<div class="container nopad">
			<div class="row bs-wizard" style="border-bottom:0;">
				...
				<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 bs-wizard-step complete"><!-- complete -->
				...
				<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 bs-wizard-step active"><!-- complete -->
					...
					<div class="progress"><div class="progress-bar"></div></div>
					<a href="#" class="bs-wizard-dot"></a>
					<div class="hidden-xs bs-wizard-info text-center" style="color:#424242;font-size:1em;padding-top:1.5%;">Konfirmasi Pemesanan</div>
					<div class="hidden-sm hidden-md hidden-lg bs-wizard-info text-center" style="color:#424242;font-size:1em;padding-top:3%;">
					Langkah 3</div>
				</div>
			</div>
	...
	<div class="container-fluid nopad" style="padding-top:6%;">
		<div class="container-fluid nopad space-ship-1" style="">
			<h2 class="text-left title" style="">Konfirmasi Pemesanan</h2>
		</div>
		<div class="container-fluid space-ship-2" style="">
			...
			<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 nopad space-ship-3" style="">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 nopad" style="padding-bottom:3%;margin-top:-10px;border-bottom:1px solid #eeeeee">
					<h5 style="font-size:1.13em;"> Data Pengiriman 
						<span class="kecil2 biru" style="padding-left:1.5%;float:right;padding-right:5%;"><i class="fa fa-pencil" aria-hidden="true"></i>
							Edit Data
						</span></h5>
						...
						<div class="col-xs-12 col-sm-6 col-md-6 col-lg-12 nopad form-field form-field-lg">
							<div class="input-group col-xs-12 col-sm-12 col-md-12 col-lg-12" style="padding-right:10px;">
								...
								<h5 style="line-height:20px;"> Jl. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur ornare, magna euismod ultrices facilisis, felis justo efficitur ipsum, ut blandit tortor augue sed ipsum. </h5>
							</div>
						</div>
						<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 nopad form-field">
							<div class="input-group col-xs-12 col-sm-12 col-md-12 col-lg-12 field-text nopad" style="padding-right:10px;">
						...
						<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 nopad form-field">
							<div class="input-group col-xs-12 col-sm-12 col-md-12 col-lg-12" style="padding-right:10px;">
								<label for="usr">Jasa Pengiriman</label>
								<h5> 0812-1920-190</h5>
							</div>
						</div>
						
					</div>
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 nopad" style="padding-bottom:0px;padding-top:3%;">
						<h5 style="font-size:1.13em;"> Metode Pembayaran 
							<span class="kecil2 biru" style="padding-left:1.5%;float:right;padding-right:5%;"><i class="fa fa-pencil" aria-hidden="true"></i>
								Edit Data
							</span></h5>
							<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 nopad form-field">
								<div class="input-group col-xs-12 col-sm-12 col-md-12 col-lg-12 field-text nopad" style="padding-right:10px;">
									<label for="usr">Metode Pembayaran</label>
									<h5> Kartu Kredit</h5>
									<!--<input id="email" type="text" class="form-control input-edit" name="email" placeholder="Silakan masukkan Nama Penerima">-->
								</div>
							</div>
							<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 nopad form-field">
								<div class="input-group col-xs-12 col-sm-12 col-md-12 col-lg-12" style="padding-right:10px;">
									<label for="usr">Nomer Kartu Kredit</label>
									<h5> 0812-1920-190</h5>
								</div>
							</div>
							<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 nopad form-field">
							...
							<div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 nopad form-field">
								<div class="input-group col-xs-12 col-sm-12 col-md-12 col-lg-12" style="padding-right:10px;">
...
<!-- Modal -->
<div id="complete" class="modal fade" role="dialog" style="padding:5%;">
	<div class="modal-dialog">
		...
		<div class="modal-content">
			<div class="modal-header" style="border:none;">
				<button type="button" class="close" data-dismiss="modal">&times;</button>
				<div class="container-fluid nopad text-center" style="padding-left:3%;margin-bottom:-5px;">
					<img src="images/icons/ic-complete.svg" style="width:33%;height:auto;">
				</div>
			</div>
			<div class="modal-body text-center nopad" style="padding:0% 14% 2% 14%">
				<h3 class="title"> Thank you for The Order!</h3>
				<h5 class="" style="line-height:23px;"> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus eget eros condimentum, posuere tortor vitae. </h5>
			</div>
			<div class="modal-footer" style="padding:0% 12% 5% 12%;border-top:none;">
				<!--<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>-->
				<button class="btn-defaults" style="padding:3.5% 5% 3.5% 5%;border-radius:3px;width:100%;margin-bottom:2.5%;" id="buyitem" data-dismiss="modal">
				OK</button>
			</div>
		</div>
